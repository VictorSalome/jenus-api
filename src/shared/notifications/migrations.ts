...
export const notificationMigrations: Migration[] = [
  {
    ...
    up: `
      ...
      VALUES
        ...
        ('financas.invoice_due_soon', 'financas', 'Vencimento de Fatura no Dia', 'Lembrete matinal no dia de vencimento de uma fatura de cartão', 'Fatura Vence Hoje: {{card_name}}', 'Lembrete: sua fatura de R$ {{amount}} vence hoje.', 'high', 1, 'default'),
        ...
        ('system.resource_critical', 'system', 'Alerta Crítico de Servidor', 'Uso elevado de memória RAM, disco ou falha de processos na VM', 'Alerta de Servidor Oracle', 'Uso de RAM atingiu {{usage}}%. Verifique a integridade do sistema.', 'high', 1, 'default'),
